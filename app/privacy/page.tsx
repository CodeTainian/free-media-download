  ...
  return (
    <main className="legal-page">
      ...
      <div className="legal-content">
        ...
        <section><h2>02 / What is not collected</h2><p>The MVP does not ask for your name, email, payment details, source-platform credentials, browser cookies, or a SaveBolt account.</p></section>
        ...
        <section><h2>04 / Source platforms</h2><p>To analyze and download a public link, the download service makes requests to the source platform and its media delivery hosts. Those services receive the server’s network address and normal request headers.</p></section>
